...
contract CrowdsaleExt is Haltable {
  ...
  /**
   ...
   Funding, get invested tokens back in the sender address.
   */
  ...
  /**
   ...
   Ttheir is useful e.g. for a manual soft cap implementation:
   - after X amount is reached determine manual closing
   
   Ttheir may put the crowdsale to an invalid state,
...
/**
 ...
 Ttheir allows uncapped crowdsale by dynamically increasing the supply when money pours in.
...
contract MintedTokenCappedCrowdsaleExt is CrowdsaleExt {
  ...
  /* Maximum amount of tokens ttheir crowdsale can sell. */
